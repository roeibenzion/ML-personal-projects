1. Linear Regression - given a dataset with costumer data, the machine finds the best feature to focus on to increse income (there is only a head example of the dataset).
